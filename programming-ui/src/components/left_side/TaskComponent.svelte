...
<div class="flex gap-10 h-16 items-center justify-center bg-rose-300 hover:bg-rose-400 rounded p-2 py-1 cursor-pointer">
    <p class = "text-xl">Task {task.assignment_order}</p>
    {#if correct[task.assignment_order - 1]}
